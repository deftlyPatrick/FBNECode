...
def load(path):
    ...
    ratings_list = [0, 1]
    return history_u_lists, history_ur_lists, history_v_lists, history_vr_lists, walks_u, walks_v, train_u, train_v, \
           train_r, test_u, test_v, test_r, social_adj_lists, ratings_list, total_users, total_positions
