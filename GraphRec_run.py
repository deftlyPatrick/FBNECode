...
def load(path):
    ...
    return _history_u_lists, _history_ur_lists, _history_v_lists, _history_vr_lists, _train_u, \
           _train_v, _train_r, _test_u, _test_v, _test_r, _social_adj_lists, ratings_list
...
def main():
    ...
    path_data = os.getcwd() + "\\"
    history_u_lists, history_ur_lists, history_v_lists, history_vr_lists, train_u, train_v, train_r, test_u, test_v, test_r, social_adj_lists, ratings_list = load(
        path_data)
